    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-300 mb-6">
              Moda con estilo y calidad. Encuentra las mejores prendas 
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              ...
              <li>📧 clery.sharongianella@gmail.com</li>
              <li>🕘 Horario: 9:00 a 20:00 hs</li>
              <li>📦 Envíos a todo el país</li>
              <li>📍 Puntos de entrega: San Miguel y José C. Paz</li>
            </ul>
            
            <div className="mt-4">
              <h4 className="font-semibold mb-2">Seguinos</h4>
              <ul className="text-sm text-gray-400">
                <li>Instagram: @cleryoficial</li>
                <li>TikTok: @cleryoficial</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-300">
          <p>&copy; 2025 CLERY. Todos los derechos reservados.</p>
